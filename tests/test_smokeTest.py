...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("ma")
    self.driver.find_element(By.ID, "password").send_keys("ma")
  ...
  def test_homePage1(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1562, 850)
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("ma")
    self.driver.find_element(By.NAME, "lname").send_keys("ma")
    self.driver.find_element(By.NAME, "bizname").send_keys("ma")
    self.driver.find_element(By.NAME, "biztitle").send_keys("ma")
